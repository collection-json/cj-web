...
step into the details of handling Cj responses.

With this complete, we can start working a more complete and visually interesting hypermedia client for Cj responses.
